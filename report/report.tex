...
You can find the live site at \url{https://sw3do.github.io} and the source code at \url{https://github.com/sw3do/sw3do.github.io}. The goal is simple: to show a hiring manager what I can actually build, for a working-student role in Berlin.
...
\IfFileExists{assets/lighthouse.png}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.85\textwidth]{assets/lighthouse.png}
    \caption{Google Lighthouse audit of \texttt{sw3do.github.io} (run on a local production preview): Performance~92, Accessibility~96, Best Practices~100 and SEO~92.}
